      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="/vuser/{{$user->id}}/update" method="POST">
              {{csrf_field()}}
                <!-- text input -->
                <div class="form-group">
                            <label >Nama</label>
                            <input name="name" type="text" class="form-control"  value="{{$user->name}}" placeholder="Nama"  required>
                        </div>
                        <div class="form-group">
                            <label >NIP</label>
                            <input name="nip" type="text" class="form-control"  value="{{$user->nip}}" placeholder="NIP" maxlength="12" onKeyPress="return kodeScript(event,'0123456789',this)" required>
                        </div>
                        <div class="form-group">
                            <label >Username</label>
                            <input name="username" type="text" class="form-control" value="{{$user->username}}" placeholder="username" required>
                        </div>
                        <div class="form-group">
                            <label >Email</label>
                        ...
                        <div class="form-group">
                            <label >Jabatan</label>
                            <input name="jabatan" type="text" class="form-control" value="{{$user->jabatan}}" placeholder="Jabatan" required>
                        </div>
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                      ...
                      <select name="role" class="form-control" id="dinas" style="margin-bottom: 10px;">
                        ...
                        <option value="adminsop" @if($user->role == 'adminsop') selected @endif>Admin SOP</option>

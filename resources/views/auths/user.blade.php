...
<!-- As a heading -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-hover datatab">
                ...
                <tr>
                  ...
                  <td><a href="/vuser/{{$user->id}}/edit" class="btn editbtn" data-toggle="modal" data-target=""><img src="{{ asset('admin/icon/edit.png') }}" height="20" width="20"></a>
                  <a href="/vuser/{{$user->id}}/delete" ><img src="{{ asset('admin/icon/delete.png') }}" height="20" width="20"></a></td>
    ...
    <div class="modal fade" id="tambahdinas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <form action="vuser/create" method="POST">
                    {{csrf_field()}}
                        <div class="form-group">
                            <select class="form-control" name="dinas_id" id="dinas" style="margin-bottom: 10px;">
                        ...
                        <div class="form-group">
                           ...
                           <option value="adminsop">Admin SOP</option>
                        ...
                        <div class="form-group">
                            <label >Masukan Password Yang Sama</label>

...
<aside class="main-sidebar">
    ...
    padding-bottom: 10px;" height="30" width="30"> <span> Beranda</span>
        ...
        <li>
          <a href="{{url('/lihatlaporan')}}"><img src="{{ asset('admin/icon/report.png') }}" style="padding-right: 10px;
    padding-bottom: 10px;" height="30" width="40"> <span>Lap Audit Penerapan</span>

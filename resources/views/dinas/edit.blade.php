        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Ubah Data Dinas</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="/vdinas/{{$dinas->id}}/update" method="POST">
              {{csrf_field()}}
                <!-- text input -->
                <div class="form-group">
                  <label>Nama Dinas</label>
                  <input type="text" name="nama_dinas" class="form-control" value="{{$dinas->nama_dinas}}" required>
                </div>
                <div class="form-group">
                  <label>Kepala Dinas</label>
                  <input type="text" name="kepala_dinas" class="form-control" value="{{$dinas->kepala_dinas}}"  required>
                </div>
                <!-- textarea -->
                <div class="form-group">
                  <label>Alamat</label>
                  <textarea class="form-control" name="alamat" rows="3" value="" required>{{$dinas->alamat}}</textarea>
                </div>
                <div class="form-group">
                  <label>Email</label>
                  <input type="email" name="email" class="form-control" value="{{$dinas->email}}" required>
                </div>
                <div class="form-group">
                  <label> No Telepon</label>
                  <input type="text" name="no_telepon" class="form-control"  maxlength="12" onKeyPress="return kodeScript(event,'0123456789',this)" value="{{$dinas->no_telepon}}" required>
                </div>

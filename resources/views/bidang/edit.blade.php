      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="/vbidang/{{$bidang->id}}/update" method="POST">
              {{csrf_field()}}
                <!-- text input -->
                ...
                <option value="{{$dinas->id}}" {{ ( $dinas->id == $bidang->dinas_id) ? 'selected' : '' }}>{{$dinas->nama_dinas}} </option>
                @endforeach
                      </select>
                    </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="kepala_bidang" class="form-control" value="{{$bidang->kepala_bidang}}"  required>
                </div>
                <button onclick="return confirm('Apa data ini telah sesuai ?')" type="submit" name="upadatedata" class="btn btn-primary" style="float:right">Ubah</button>
                </form>
                </div>
                </div>
                </div>

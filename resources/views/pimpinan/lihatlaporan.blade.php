        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- Button trigger modal -->
					<a href="/cetaklaporan/lihatlaporan_pdf"> <button type="button" class="btn btn-primary btn-sm right" style="float: right; margin-right: 20px;
            margin-bottom: 10px;" >
                  Unduh Laporan (ALL)
                </button></a>
                
                <a href="/lihatlaporanchart"> <button type="button" class="btn btn-primary btn-sm right" style="float: right; margin-right: 20px;
                  margin-bottom: 10px;" >
                        Grafik
                      </button></a>
                  <!-- /.box-header -->
                  ...
                  <div class="box-body">
                      ...
                      <form>
                      <select class="form-control" id="aktivitas" style="margin-bottom: 10px;">
                  ...
                  <td><form action="laporanperiode" method="get" class="form-group">
                      {{csrf_field () }}
                    ...
                    <td>
                        <button type="submit" name="Lihat" class="btn btn-primary" style="
                        margin-left: 10px;
                        margin-bottom: 13px;
                        padding-bottom: 5px;
                        padding-top: 5px;
...
<script type="text/javascript">
  $(document).ready(function(){
      $('#aktivitas').on('change', function(e){
          var id = e.target.value;
          $.get('{{ url('lihatlaporan')}}/'+id, function(data){
              console.log(id);
              console.log(data);
              $('#jawaban').empty();
              $.each(data, function(lihatlaporan, element){
                  $('#jawaban').append("<tr><td>"+element.aktivitas.nama_aktivitas+"</td><td>"+element.sop.nama_sop+"</td><td>"+element.tanggal+"</td><td>"+element.sop.versi+"</td><td>"+element.catatan1+"</td><td>"+element.hasil+"</td><td><a href='/print/"+element.id+"'>Cetak</a></td></tr>");
              });
          });
      });
  });
  ...
  $(document).ready(function(){
      $('#tanggal').on('change', function(e){
          ...
          $.get('{{ url('lihatlaporan')}}/'+id, function(data){
              ...
              $('#jawaban').empty();
              $.each(data, function(lihatlaporan, element){
                  $('#jawaban').append("<tr><td>"+element.aktivitas.nama_aktivitas+"</td><td>"+element.sop.nama_sop+"</td><td>"+element.tanggal+"</td><td>"+element.sop.versi+"</td><td>"+element.catatan1+"</td><td>"+element.hasil+"</td></tr>");
              });
          });
      });
  });

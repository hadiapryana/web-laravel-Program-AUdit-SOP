      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="/vdoksop/arsip" method="POST">
              {{csrf_field()}}
                <!-- text input -->
                    <div class="form-group">
                            <label >Nama SOP</label>
                            <input name="nama_sop" type="text" class="form-control" value="{{$sop->nama_sop}}" placeholder="Nama SOP" required>
                        </div>
                        <div class="form-group">
                            <label >File SOP</label>
                            <input disabled name="file" type="text" class="form-control" value="{{$sop->file}}"  placeholder="File SOP" required>
                        </div>
                        <div class="form-group">
                            <label >Versi</label>
                            <input name="versi" type="text" class="form-control" value="{{$sop->versi}}" placeholder="versi" required>
                        </div>
                        <div class="form-group">
                            <label >Status</label>
                            <input name="status" type="text" class="form-control" value="{{$sop->status}}" placeholder="status" required>
                        </div>
                        
                        <div class="form-group">
                            <label >tanggal Penetapan</label>
                            <input name="tgl_penetapan" type="date" class="form-control" value="{{$sop->tgl_penetapan}}" placeholder="tgl_penetapan" required>
                        </div>
                        <div class="form-group">
                            <label>tanggal pemberhentian</label>
                            <input name="tgl_pemberhentian"  type="date" class="form-control" value="{{$sop->tgl_pemberhentian}}" placeholder="tgl_pemberhentian" required >
                        </div>
                        <label >keterangan</label>
                        <div class="form-group">
                            <textarea name="keterangan" type="text" cols="90" rows="4" placeholder="keterangan" required> Sudah di arsipkan </textarea>
                        </div>
